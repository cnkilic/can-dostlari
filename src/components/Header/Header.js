          ...
          <div className="relative group md:static h-full">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4 py-12 px-8">
                ...
                <div>
                  <Link href="/"  className="font-semibold text-lg">CHAINS</Link>
                  <ul className="mt-2 space-y-1">
                    <li>
                      <Link href="/" className="text-gray-600 hover:text-black">
                        MVINTAGE COLLECTION
                ...
                <div>
                  <Link href="/"  className="font-semibold text-lg">BRACELETS</Link>
                  <ul className="mt-2 space-y-1">
                    <li>
                      <Link href="/" className="text-gray-600 hover:text-black">
                        MVINTAGE COLLECTION
                ...
                <div>
                  <Link href="/"  className="font-semibold text-lg">ERRINGS</Link>
                  <ul className="mt-2 space-y-1">
                    <li>
                      <Link href="/" className="text-gray-600 hover:text-black">
                        MVINTAGE COLLECTION
                ...
                <div>
                  <Link href="/"  className="font-semibold text-lg">RINGS</Link>
                  <ul className="mt-2 space-y-1">
                    <li>
                      <Link
                        href="/"
